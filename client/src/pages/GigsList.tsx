...
export default function GigsList() {
  ...
  return (
    <DashboardLayout title="Explore Gigs">
              ...
              <Link key={gig._id} to={`/gigs/${gig._id}`} style={{ textDecoration: 'none' }}>
                ...
                >
                  ...
                  <div style={{ padding: 20, display: 'flex', flexDirection: 'column', flex: 1 }}>
                    ...
                    <div style={{ borderTop: `1px solid ${T.border}`, margin: '0 -20px 16px', padding: '16px 20px 0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                        <div style={{ width: 24, height: 24, borderRadius: '50%', backgroundColor: T.border, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                          <UserIcon size={12} color={T.muted} />
                        </div>
                        <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 13, fontWeight: 500, color: T.ink }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                      ...
                      <div>
                        <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 11, color: T.muted, display: 'block', textAlign: 'right' }}>STARTING AT</span>
